...
floor1 = { '45_dyp_1.dat'	'45_dyp_2.dat'	'45_dyp_3.dat'	'45_dyp_4.dat'  '56_dyp_1.dat'	'56_dyp_2.dat'	'56_dyp_3.dat'   '56_dyp_4.dat' '45_lyj_1.dat'	'45_lyj_2.dat'	'45_lyj_3.dat' '45_lyj_4.dat'  '56_lyj_1.dat'	'56_lyj_2.dat'	'56_lyj_3.dat' '56_lyj_4.dat' '45_szj_1.dat'	'45_szj_2.dat'	'45_szj_3.dat' '45_szj_4.dat'  '56_szj_1.dat'	'56_szj_2.dat'	'56_szj_3.dat' '56_szj_4.dat'};
floor2 = {  '54_dyp_1.dat'	'54_dyp_2.dat'	'54_dyp_3.dat' '54_dyp_4.dat'      '65_dyp_1.dat'	'65_dyp_2.dat'	'65_dyp_3.dat'	'65_dyp_4.dat' '54_lyj_1.dat'	'54_lyj_2.dat'	'54_lyj_3.dat' '54_lyj_4.dat'  '65_lyj_1.dat'	'65_lyj_2.dat'	'65_lyj_3.dat'  '65_lyj_4.dat'   '54_szj_1.dat'	'54_szj_2.dat'	'54_szj_3.dat' '54_szj_4.dat' '65_szj_1.dat'	'65_szj_2.dat'	'65_szj_3.dat' '65_szj_4.dat'};
%%
n_timestamps = 4;
step_size = 1;
test_ratio = 0.2;
...
for dataName = floor1
    ...
    tmp2 = get_window(cCSI(startIdx:startIdx+floor(test_ratio*n),:,:,:),n_timestamps,step_size);
    tmp3 = get_window(cCSI(startIdx+floor(test_ratio*n)+1:end,:,:,:),n_timestamps,step_size);
    train_CSI_presence1 = cat(1,train_CSI_presence1,tmp1,tmp3);
    test_CSI_presence1 = cat(1,test_CSI_presence1,tmp2);
...
for dataName = floor2
    ...
    tmp2 = get_window(cCSI(startIdx:startIdx+floor(test_ratio*n),:,:,:),n_timestamps,step_size);
    tmp3 = get_window(cCSI(startIdx+floor(test_ratio*n)+1:end,:,:,:),n_timestamps,step_size);
    train_CSI_presence2 = cat(1,train_CSI_presence2,tmp1,tmp3);
    test_CSI_presence2 = cat(1,test_CSI_presence2,tmp2);
...
Y_train = cat(1,ones(size(X_train_CSI_empty,1),1),ones(size(X_train_CSI_empty,1),1),2*ones(size(X_train_CSI_presence1,1),1),3*ones(size(X_train_CSI_presence2,1),1));
CSI_train = cat(1,X_train_CSI_empty,X_train_CSI_empty,X_train_CSI_presence1,X_train_CSI_presence2);
% Y_train = categorical(Y_train);
CSI_test = cat(1,X_test_CSI_empty,X_test_CSI_presence1,X_test_CSI_presence2);
Y_test = cat(1,ones(size(X_test_CSI_empty,1),1),2*ones(size(X_test_CSI_presence1,1),1),3*ones(size(X_test_CSI_presence2,1),1));
